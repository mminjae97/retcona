...
from auth.oauth import router as google_router
...
app.include_router(google_router, prefix="/auth/google", tags=["auth"])
app.include_router(signup_verification_router, prefix="/auth/signup", tags=["auth"])
